...
public class Zoo {
    ...
    public static void main(String[] args) {
        ...
        myZoo.putAnimalInCage(myZoo.getCageAtIndex(0), new Animal("Zebra"));
        myZoo.putAnimalInCage(myZoo.getCageAtIndex(2), new Animal());
        System.out.println(myZoo.getCages());
        // Move an animal from one cage to another
        myZoo.moveAnimal(myZoo.getCageAtIndex(2),myZoo.getCageAtIndex(1), myZoo.getCageAtIndex(0).getAnimalAtIndex(0));
